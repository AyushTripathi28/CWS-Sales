...
import 'package:cwssales/services/db3proposal.dart';
...
class _AddProposalListState extends State<AddProposalList> {
  ...
  DbProposal dbMethod = new DbProposal();
                  ...
                  onTap: (){
                    if(descEditingController.text== "" || titleEditingController.text=="" || linkEditingController.text=="" ){
                      ...
                      Navigator.pushReplacement(
                          context, MaterialPageRoute(builder: (context) => Proposals()));
                    }
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [const Color(0xff2A75AC),const Color(0xff007C), const Color(0xff2A75AC)],
                        )),
